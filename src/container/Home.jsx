...
const Home=()=>{
    ...
    return <>
        <div className={`w-2 ${isSideMenu ? "w-2" : "flex-[.2] xl:flex-[.2]"} min-h-screen max-h-screen relative bg-secondary px-3 py-6 flexx flex-col items-center justify-start gap-4 transition-all duration-200 ease-in-out`}>
        ...
        <div className='overflow-hidden w-full flex flex-col gap-4'>
            {/* logo */}
                <Link to={"/home"}>
                    <img src={logo} alt="Logo" className='object-contain w-75 h-auto' />
                </Link>
            {/* start coding */}
                <Link to={"/newProject"}>
        ...
        {/* ----------------------RIGHT-SIDE----------------- */}
        <div className='flex-1 min-h-screen max-h-screen overflow-y-scroll h-full flex flex-col items-start justify-start px-4 md:px-12 py-4 md:px-12'>
            {/* top section */}
            <div className='w-full flex items-center justify-beteen gap-3'>
                {/* search */}
